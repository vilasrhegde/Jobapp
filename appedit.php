...
//CREATE TRIGGER `update_info` BEFORE UPDATE ON `locate`
// FOR EACH ROW INSERT into update_log SET name=OLD.name,position=OLD.position,app_id=OLD.id,city=OLD.branch
